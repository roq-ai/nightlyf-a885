...
export const HelpBox: React.FC = () => {
  ...
  const tenantRoles: string[] = ['Event Organizer', 'Social Media Promoter', 'User'];
  const addOns: string[] = ['notifications', 'chat', 'file'];
  const applicationName = `nightlyf`;
  const tenantName = `Student`;
