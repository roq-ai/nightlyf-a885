...
import { getGuestListById } from 'apiSdk/guest-lists';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Guest List Detail View
          </Text>
          {hasAccess('guest_list', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/guest-lists/edit/${data?.id}`} passHref legacyBehavior>
              <Button
