...
import { getRsvps, deleteRsvpById } from 'apiSdk/rsvps';
...
function RsvpListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('rsvp', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/rsvps/view/${id}`);
    }
  };
  ...
  return (
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('rsvp', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Flex justifyContent="space-between" mb={4}>
            <Text as="h1" fontSize="2xl" fontWeight="bold">
              Rsvp
            </Text>
            <NextLink href={`/rsvps/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('rsvp', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/rsvps/edit/${record.id}`} passHref legacyBehavior>
                          <Button
